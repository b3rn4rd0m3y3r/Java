...
public class MyMailServer_02 {
    static public boolean DEBUG = true;
    public static void main(final String s[]) throws UnknownHostException, IOException {
        final MyMailServer_02 server = new MyMailServer_02(BaseMail.SMTP_PORTS);
        // Inicia server
		server.start();
    ...
    public MyMailServer_02(final int[] pPorts) throws IOException {
